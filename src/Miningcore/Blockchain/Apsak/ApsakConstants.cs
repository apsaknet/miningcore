...
public static class ApsakConstants
{
    ...
    // SAK smallest unit is called IPMOS: https://github.com/kaspanet/kaspad/blob/master/util/amount.go
    public const decimal SmallestUnit = 100000000;

    // List of SAK prefixes: https://github.com/kaspanet/kaspad/blob/master/util/address.go
    public const string ChainPrefixDevnet = "apsakdev";
    public const string ChainPrefixSimnet = "apsaksim";
    public const string ChainPrefixTestnet = "apsaktest";
    public const string ChainPrefixMainnet = "apsak";
    ...
    public const string ProtobufWalletRpcServiceName = "apsakwalletd.apsakwalletd";

    public const byte PubKeyAddrID = 0x00;
    public const byte PubKeyECDSAAddrID = 0x01;
    public const byte ScriptHashAddrID = 0x08;
    public static readonly Dictionary<byte, string> ApsakAddressType = new Dictionary<byte, string>
    {
