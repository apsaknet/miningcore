...
namespace Miningcore.Blockchain.Apsak.Configuration;

public class ApsakPoolConfigExtra
{
    /// <summary>
    ...
    /// <summary>
    /// Arbitrary string added in the Apsak coinbase tx
    ...
    /// Should match the value of .proto file
    /// Default: "apsakwalletd.apsakwalletd"
    /// </summary>
